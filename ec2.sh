...
aws ec2 run-instances --image-id ami-09d56f8956ab235b3 --count 1 --instance-type t2.micro --key-name 1st --security-group-ids sg-04f878f8bcdf98db2 --subnet-id subnet-02874d60cddbf6e1d

echo "   -------------------------------- "


echo "   Jenkins slave node on AWS EC2 is going to run   "



echo "   ACA Dev/Ops Bootcamp, by Armen Petrosyan   "
